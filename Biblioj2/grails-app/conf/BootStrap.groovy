...
class BootStrap {
    ...
    def init = { servletContext ->
		if (!Livre.count()){
			...
			new Livre(titre:"La couleur des sentiments", auteurs:stockett, type:nouveaute, nombreExemplairesDisponibles: 1, nombreExemplaires:1).save(failOnError: true)
			...
			new Livre(titre:"La révolte", auteurs:collins, type:ado, nombreExemplairesDisponibles: 1, nombreExemplaires:1).save(failOnError: true)
			new Livre(titre:"La liste de mes envies", auteurs:delacourt, type:adulte, nombreExemplairesDisponibles: 0, nombreExemplaires:1).save(failOnError: true)
			...
			new Livre(titre:"Journal d'un corps", auteurs:pennac, nombreExemplairesDisponibles: 1, nombreExemplaires:1).save(failOnError: true)
			new Livre(titre:"La vérité sur l'affaire Harry Quebert : roman", auteurs:dicker, type:adulte, nombreExemplairesDisponibles: 3, nombreExemplaires:3).save(failOnError: true)
